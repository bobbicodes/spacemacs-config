...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(html
     ...
     ;; Uncomment layer names and press `SPC f e R'  to install them.
     helm
